  ...
  <div class="tab-content default-tab" id="tab1">
          ...
          <table>
			...
			<?php
				include "connect.php";
				$vConn = fConnect();
				$vSql ="SELECT P.nomAsso,M.numEtudiant,M.nom,M.Prenom 
          ...
          <table>
			...
			<?php
				$vConn = fConnect();
				$vSql ="SELECT D.nomAsso,M.nom,D.Types 
						FROM Dirigeant D , Membre M
						WHERE D.numEtu = M.numEtudiant;";
				$vQuery=pg_query($vConn, $vSql);
				while ($vResult = pg_fetch_array($vQuery)) {
					echo "<tr>";
					echo "<td>$vResult[0]</td>";
